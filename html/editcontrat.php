...
?> 
                            <div class="row">
                                <div class="col">
                                    ...
                                    value="<?php echo $contrat->REF;?>" required></input>
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    value="<?php echo $contrat->DATE ?>" required/>
                                </div>
                                <div class="col">
                                    ...
                                    <select id="position" class="form-control" name="position">
                                        <?php foreach(GetCodeAnalytique(22,0,50) as $national): ?>
                                            ...
                                            <?php echo $national->CODLIB==$contrat->POSITION? "selected":"" ?>><?php echo utf8_encode($national->LIBLONG) 	?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <?php foreach(GetCodeAnalytique(39,0,200) as $national): ?>
                                            <option value="<?php echo $national->CODLIB?>"
                                            <?php echo $national->CODLIB==$contrat->CODE_FONCT? "selected":"" ?>>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    value="<?php echo $contrat->DEBUT ?>" required/>
                                </div>
                                <div class="col">
                                    <label>Date Fin</label>
                                    <input type="date" class="form-control" id="datefin" name="datefin"
                                    value="<?php echo $contrat->FIN;?>">
                                </div> 
                                ...
                                <div class="col">
                                    ...
                                    <select id="grade" class="form-control" name="grade">
                                        <?php foreach(GetCodeAnalytique(54,0,700) as $national): ?>
                                            <option value="<?php echo $national->CODLIB ?>"
                                            <?php echo $national->CODLIB==$contrat->GRADE? "selected":"" ?>>
                                            <?php echo utf8_encode($national->LIBLONG) 	?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>    
                                ...
                                <div class="col">
                                    ...
                                    value="<?php echo $contrat->SAL_BASE;?>" required>
                                </div>  
                                ...
                                <div class="col">
                                    ...
                                    <select id="Programme" class="form-control" name="Programme">
                                        <?php foreach(GetProgrammes(20,0,600) as $national): ?>
                                            ...
                                            <?php echo $national->id==$contrat->PROGRAMME? "selected":"" ?>>
                                ...
                                <div class="col">
                                    ...
                                    <select id="LIEUAFFEC" class="form-control" name="LIEUAFFEC">
                                        <?php foreach(GetCodeAnalytique(53,0,50) as $national): ?>
                                            ...
                                            <?php echo $national->LIBLONG==$contrat->LIEU? "selected":"" ?>><?php echo utf8_encode($national->LIBLONG) 	?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div> 
                                ...
                                <div class="col">
                                    ...
                                    <select id="codebudget" class="form-control" name="codebudget" >
                                        <?php foreach(GetCodeAnalytiqueActive(50,0,200) as $national): ?>
                                            <option value="<?php echo $national->CODLIB ?>" 
                                            <?php echo $national->CODLIB==$contrat->COMPTE? "selected":"" ?>>
                               ...
                               <div class="col">
                                    ...
                                    <select id="REL_BANQUE" class="form-control" name="REL_BANQUE">
                                        <?php foreach(GetCodeAnalytique(51,0,50) as $national): ?>
                                            <option value="<?php echo $national->LIBLONG ?>"
                                            <?php echo $national->LIBLONG==$contrat->CODE_BANQ? "selected":"" ?>>
                                            <?php  echo  utf8_encode($national->LIBLONG) 	?></option>
                                        <?php endforeach; ?>
                                    </select> 
