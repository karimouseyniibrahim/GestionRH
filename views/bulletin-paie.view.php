			     ...
			     <div class="row">
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
					     <div class="row">
						     <div class="col-sm-3 p-0 flex justify-content-lg-start justify-content-center">
							    <h2 class="ml-lg-2">Gestion <?php echo $title?></h2>
							 </div>
							 <div class="col-sm-9 p-0 flex justify-content-lg-end justify-content-center">
                                <a  class="btn btn-success" href="print/billetage.php" target="_blank">
							        <span>Billetage</span>
							   </a>
                                <a  class="btn btn-success" href="print/ordres_virements.php" target="_blank">
							        <span>Etat OV</span>
							   </a>
                               <a  class="btn btn-success" href="print/cnss.php" target="_blank">
							        <span>Etat Cnss</span>
							   </a>
                               <a  class="btn btn-success" href="print/journal-paie.php" target="_blank">
							        <span>Journal de paie</span>
							   </a>
                               <a  class="btn btn-success" href="print/elements-salaires.php" target="_blank">
							        <span>Element Salaires</span>
							   </a>
                               
							   <a href="bulletin-paie.php?calcule=1" class="btn btn-danger" target="_blank" >
...
<script type="text/javascript">
    ...
    function CalculDatefin(dateAppel){
        ...
        dt.setMonth(document.getElementById("AddNBRE_ECHEA").value-1);     
