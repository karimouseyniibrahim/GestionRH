				    ...
				    <div class="col-md-12">
					   ...
					   <div class="table-title">
                        ...
                        <div class="row mt-4">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Compte Budget" list="list-Compte" id="Compte-datalist" >
...
<script type="text/javascript">
    ...
    function loadContrat(){
        var supp=document.getElementById("Chercheur-datalist").value;
        var code=document.getElementById("CodeAnalytique-datalist").value;
        $.ajax({
            type : "POST",  //type of method
            url  : "manoeuvres-contrat.php",  //your page
            data : { supp : supp,code:code, Request : "infosContrat"},// passing the values
            success: function(res){  
