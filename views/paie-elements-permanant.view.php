                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input id="Editsauve_Paiement" onclick="EditConsommation()" name="sauve_Paiement"  class="btn btn-success" value="Enregistrer">
                                        ...
                                        <!----edit-modal end--------->	   
                    <!----delete-modal start--------->
                        <div class="modal fade" tabindex="-1" id="DeleteElementPaieModal" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
...
<script type="text/javascript">
    ...
    function openmodal(id) { 
        ...
        $.ajax({
            ...
            data : { id : id, ElementP : "ElementP", element:"P"},// passing the values
    ...
    function openmodaldelete(id) {         
        ...
        $('#DeleteElementPaieModal').modal('show');        
    }
    ...
    function loadElementPermanant(idPersonnnel){
        ...
        $.ajax({
            type : "POST",  //type of method
            url  : "data/personnels.php",  //your page
            data : { matricule : matricule, infos : "infos",element:"P"},// passing the values
            success: function(res){  
            //do what you want here...
            var dta=JSON.parse(res);
    ...
    function addPAIEMENT(){
        ...
        $.ajax({
            ...
            data : { id:id,sauve_Paiement : sauve_Paiement, MATRICULEV : MATRICULEV,CODE:CODE,
                VALEUR:VALEUR,COMPTE:COMPTE,element:'P'},// passing the values
            success: function(res){  
            //do what you want here...
            $('#TableElementPermanant tbody').empty();
     ...
     function DeleteElementPaie(){
        ...
        $.ajax({
            type : "POST",  //type of method
            url  : "paie-elements-permanant.php",  //your page
            data : { sauve_Paiement : sauve_Paiement,id:id,MATRICULEV:MATRICULEV,element:'P'},// passing the values
            success: function(res){  
            //do what you want here...
            $('#TableElementPermanant tbody').empty();
            $('#TableElementPermanant tbody').append(res);
           // alert(res);
            $('#DeleteElementPaieModal').modal('hide');
            }
        }); 
     }
</script>
